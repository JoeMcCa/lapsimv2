function [Results] = concept_study(awd,hub,regen,regenmult)
...
var = 20;%linspace(15,25,5);
var2 = 180;%linspace(60,80,5);
...
vehicle.ClA = 3.5*sens.ClAsens(sensindex);
...
vehicle.awd = awd;
vehicle.regen = regen;
vehicle.regenmax = vehicle.Pmax*regenmult;
if vehicle.hub == 0
    vehicle.awd = 0;
...
%vehicle.Vmaxset = 150; 
%% Run Autox Sim
if awd == 0 && hub == 1 && regen == 1
    [autoxresults] = autoxsimrwd(vehicle,track,simsetup);
else
